...
<script>
    ...
    // Get Data
    firebase.database().ref('hauler/').on('value', function (snapshot) {
    ...
    $('#submitCustomer').on('click', function () {
        ...
        console.log(values);
        firebase.database().ref('hauler/' + userID).set({
            uid: uid,
            name: name,
            email: email,
        });
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('hauler/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateCustomer').on('click', function () {
        ...
        var updates = {};
        updates['/hauler/' + updateID] = postData;
    ...
    $('.deleteRecord').on('click', function () {
        ...
        firebase.database().ref('hauler/' + id).remove();
